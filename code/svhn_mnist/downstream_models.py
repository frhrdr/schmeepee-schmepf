...
def prep_models(custom_keys, skip_slow_models, only_slow_models):
  ...
  model_specs['decision_tree'] = {'class_weight': 'balanced'}
...
def test_passed_gen_data(data_key, data_log_name, datasets_colletion, log_save_dir, log_results=True,
  ...
  return [g_to_r_acc_summary, mean_acc]
