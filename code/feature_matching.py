...
from feature_selection_pca import PCAMapping
...
def extract_features_with_hooks(data_batch, encoders: Encoders):
  ...
  if encoders.prune_mode is not None:
    ...
    for layer_name in encoders.layer_feats:
      ...
      if encoders.prune_mode == 'pca':
        pca_map: PCAMapping = encoders.pca_maps[layer_name]
        pruned_feats.append(pca_map.map_batch(feats))
      elif encoders.prune_mode == 'channels':
