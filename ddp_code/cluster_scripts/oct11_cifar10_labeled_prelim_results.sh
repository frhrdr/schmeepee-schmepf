...
case $1 in
0 )
python3 dp_mepf.py --pytorch_encoders --n_iter 200_000 --valid_iter 5_000 --restart_iter 5_000 --syn_eval_iter 5_000 --dataset cifar10 --labeled --val_enc fid_features --val_data train --validation_mode static --exp_name oct11_cifar10_labeled_prelim_results/run_0 --dp_tgt_eps 0.2 --matched_moments m1_and_m2 --dp_val_noise_scaling 10. --batch_size 64 --lr 1e-3 --m_avg_lr 1e-2 --seed 1
;; 1 )
